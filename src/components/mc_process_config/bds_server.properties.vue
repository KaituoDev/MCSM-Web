  ...
  <LineOption :custom="true">
    <template #default>
      ...
      <div class="sub-title">
        ...
        <div class="sub-title-info">
          此配置文件为基岩版专用服务器主要配置文件，基岩版服务器绝大部分配置都在此配置文件进行设置，列如服务器端口，人数，视距和限制参数等。
        </div>
      </div>
    </template>
  </LineOption>
  ...
  data() {
    return {
      description: {
        ...
        "max-threads": "服务端使用的最大线程数 ( 0 则不限制 )",
        ...
        "announce-player-achievements": "玩家获得成就时, 是否在服务器聊天栏显示",
        ...
        "rcon.password": "设置RCON远程访问的密码 ( 参见 enable-rcon )",
        ...
        "spawn-protection":
          "通过将该值进行 2x+1 的运算来决定出生点的保护半径, 设置为 0 将只保护出生点下方那一个方块。"
      }
    };
  }
};
