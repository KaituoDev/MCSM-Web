    ...
    return {
      description: {
        ...
        "resource-pack-prompt":
          "可选，添加一个自定义消息，当使用 require-resource-pack 时，将显示在资源包提示窗口上。",
        ...
        "rate-limit": "当玩家客户端发送多少数据包总量时会被踢出，0 代表关闭",
        "previews-chat":
          "如果设置为是，将启用聊天预览。如果启用，服务器禁止用户使用 VPN 或代理；如果禁用，服务器不阻止用户使用vpn或代理。",
